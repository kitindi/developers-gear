...
const Sidebar = () => {
  return (
    <div>
      <ul className="py-10 ">
        <Link to="/seller-dashboard" className="flex items-center space-x-2 mb-2 cursor-pointer hover:bg-white p-2 rounded-md">
          <span>
        ...
        <Link to="/orders" className="flex items-center space-x-2 mb-2 cursor-pointer hover:bg-white p-2 rounded-md">
          <span>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="21" height="21" color="#f06b6b" fill="none">
              <path
        ...
        <Link to="/inventory" className="flex items-center space-x-2 mb-2 cursor-pointer hover:bg-white p-2 rounded-md">
          <span>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="21" height="21" color="#f06b6b" fill="none">
              <path
        ...
        <Link to="/customers" className="flex items-center space-x-2 mb-2 cursor-pointer hover:bg-white p-2 rounded-md">
          <span>
