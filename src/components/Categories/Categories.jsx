...
const Categories = () => {
  return (
    <div className="p-8 md:px-12 lg:px-28 bg-gray-50" id="categories">
      <h2 className="text-3xl text-slate-800 font-semibold mb-2 text-center">Explore Popular Categories</h2>
      <h3 className="text-md text-gray-600 text-center mb-2">Find the perfect gear for your setup!</h3>
      <div className="py-6">
        <div className="flex flex-wrap items-center justify-center gap-8 ">
          <Link to="/keyboard_mice" className=" bg-gray-100 hover:bg-white border p-2 border-red-500 rounded-full flex items-center space-x-2">
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#e02424" viewBox="0 0 256 256">
            ...
            <div>
              <p className="text-red-600 text-sm font-semibold py-1">Keyboards & Mice</p>
            </div>
          </Link>
          <Link to="/monitor" className=" bg-gray-100 hover:bg-white border p-2 border-red-500 rounded-full flex items-center space-x-2">
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#e02424" viewBox="0 0 256 256">
            ...
            <div>
              <p className="text-red-600 text-sm font-semibold">Monitors </p>
            </div>
          </Link>
          <Link to="/headphones" className=" bg-gray-100 hover:bg-white border p-2 border-red-500 rounded-full flex items-center space-x-2">
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#e02424" viewBox="0 0 256 256">
            ...
            <div>
              {" "}
              <p className="text-red-600 text-sm font-semibold">Headphones</p>
            </div>
          </Link>
          <Link to="/laptop" className=" bg-gray-100 hover:bg-white border p-2 border-red-500 rounded-full flex items-center space-x-2">
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#e02424" viewBox="0 0 256 256">
            ...
            <div>
              <p className="text-red-600 text-sm font-semibold">Laptops</p>
            </div>
          </Link>
          <Link to="/desktop_pc" className="bg-gray-100 hover:bg-white border p-2 border-red-500 rounded-full flex items-center space-x-2">
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#e02424" viewBox="0 0 256 256">
            ...
            <div>
              {" "}
              <p className="text-red-600 text-sm font-semibold">Desktop PC</p>
            </div>
          </Link>
          <Link to="/cables_charger" className=" bg-gray-100 hover:bg-white border p-2 border-red-500 rounded-full flex items-center space-x-2">
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#e02424" viewBox="0 0 256 256">
            ...
            <div>
              {" "}
              <p className="text-red-600 text-sm font-semibold"> Cables & Chargers</p>
            </div>
          </Link>
          <Link to="/desk_accessories" className=" bg-gray-100 hover:bg-white border p-2 border-red-500 rounded-full flex items-center space-x-2">
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="17" height="17" color="#E02424" fill="none">
            ...
            <div>
              <p className="text-red-600 text-sm font-semibold">Desk Accessories </p>
            </div>
          </Link>

          <Link to="/apparel" className=" bg-gray-100 hover:bg-white border p-2 border-red-500 rounded-full flex items-center space-x-2">
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="17" height="17" color="#E02424" fill="none">
                <path
            ...
            <div>
              <p className="text-red-600 text-sm font-semibold">Developer Apparel & Merch</p>
            </div>
          </Link>
        </div>
      </div>
